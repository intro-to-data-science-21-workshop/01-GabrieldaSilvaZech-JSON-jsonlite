...
# TRANSFORMING JSON DATA INTO TIDY TABLES
...
## Using `unnest_longer()` and `unnest_wider()` to unnest lists
...
## Working with atomic vectors / data frames of length 1
